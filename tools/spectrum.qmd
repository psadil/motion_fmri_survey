...
```{r, peaks}
#| eval: false
hcpa <- arrow::read_parquet(
  "/Users/psadil/git/manuscripts/motion/data/motion/derivatives/hcpa_spectrum.parquet"
) |>
...
hcpd <- arrow::read_parquet(
  "/Users/psadil/git/manuscripts/motion/data/motion/derivatives/hcpd_spectrum.parquet"
) |>
  filter(between(freq, 0.2, 0.6), param == "trans_y") |>
  slice_max(order_by = pxx, n = 1, by = c(sub, ses, task, ped)) |>
  summarise(
...
hcpya <- arrow::read_parquet(
  "/Users/psadil/git/manuscripts/motion/data/motion/derivatives/hcpya_spectrum.parquet"
) |>
...
spacetop <- arrow::read_parquet(
  "/Users/psadil/git/manuscripts/motion/data/motion/derivatives/spacetop_spectrum.parquet"
) |>
  filter(between(freq, 0.2, 0.6), param == "trans_y") |>
